...
# Save Image
def save_as_png():
    result = filedialog.asksaveasfilename(initialdir='omrisokol/TKINTER', filetypes=(("png files", "*.png"), ("all files", "*.*")))
...
#         y1=y+my_canvas.winfo_height()
        ImageGrab.grab().crop((210,150,1400,940)).save(result)
...
# Create our canvas
my_canvas = Canvas(root, width=w, height=h, bg="white", highlightthickness=1, highlightbackground="black")
